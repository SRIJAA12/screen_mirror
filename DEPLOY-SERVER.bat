...
if not exist ".env" (
    ...
    (
        ...
        echo EMAIL_FROM="Lab Management System <your-email@gmail.com>"
    ) > .env
...
(
    ...
    echo echo ========================================
    echo echo.
    echo echo Server URL: http://10.10.46.182:7401
    echo echo Admin Dashboard: http://10.10.46.182:7401/admin-dashboard.html
    echo echo.
...
echo    - Open: http://10.10.46.182:7401
echo.
